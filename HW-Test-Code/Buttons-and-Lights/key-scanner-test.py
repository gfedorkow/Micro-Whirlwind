...
class BlinkenLights:
    def __init__(self):
        ...
        print("TCA8414 Test")
        self.tca8414_1 = TCA8414(self.i2c_bus, TCA8414_1_ADDR)
        self.tca8414_1.init_tca8414()
...
class TCA8414:
    ...
    def init_gp_in(self):
        # set pins Column 6, 7 as inputs to generate a press-release interrupt
        # default is input already; self.writeRegister(self.TCA8418_REG_GPIO_DIR_2, ~0xC0)
        self.writeRegister(self.TCA8418_REG_GPI_EM_2, 0xC0)
